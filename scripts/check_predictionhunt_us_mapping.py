...
from firstbot.models import Exchange
...
def main() -> int:
    ...
    opportunities = predictionhunt.get_arbitrage_opportunities(category="", limit=25)
    legs = [
    ...
    for leg in legs:
        try:
            polymarket.resolve_predictionhunt_market(
